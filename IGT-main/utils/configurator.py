...
class Config(object):
    ...
    Configurator module will first load the default parameters from the fixed properties.
    ...
    def _set_default_parameters(self):
        smaller_metric = ['rmse', 'mae', 'logloss', 'mape', 'mare']
        valid_metric = self.final_config_dict['valid_metric'].lower()
